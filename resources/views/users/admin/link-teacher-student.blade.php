            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <button id="upload-btn" class="btn btn-primary" data-target="#CSV-Modal" data-toggle="modal">
                            Upload CSV
                        </button>
                        <hr/>
                            ...
                            <table class="table table-striped">
                                ...
                                @foreach($teachers as $teacher)
                                    <tr>
                                        ...
                                        <td>
                                            <button data-target="#Linking-Modal" data-toggle="modal"
                                                    class="btn btn-info"
                                                    onclick="chooseDocent({{ $teacher->student_id }})">
                                                {{ __('linking.koppelen') }}
                                            </button>
                        ...
                        <div class="panel-body">
                            <div class="dropdown">
                                <div id="myDropdown" class="dropdown-content">
                                    <input type="text" placeholder="{{ __('linking.placeholder') }}" id="dropdownInput"
                                           onkeyup="filterFunction()">
                                    <div class="dropdown-links">
                                        @foreach($students as $student)
                                            <a onclick="chooseStudent({{ $student->student_id }})">{{ $student->studentnr }}
